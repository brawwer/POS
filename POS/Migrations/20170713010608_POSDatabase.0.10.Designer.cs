...
namespace POS.Migrations
{
    ...
    [Migration("20170713010608_POSDatabase.0.10")]
    partial class POSDatabase010
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("POS.Models.AddedItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("AddInventoryModelId");
                    ...
                    b.HasIndex("AddInventoryModelId");
            ...
            modelBuilder.Entity("POS.Models.AddInventoryModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("POS.Models.DailySalesEntry", b =>
                {
                    ...
                    b.Property<double>("ItemPriceCOP");
            ...
            modelBuilder.Entity("POS.Models.AddedItem", b =>
                {
                    b.HasOne("POS.Models.AddInventoryModel", "AddInventoryModel")
                        .WithMany("AddedItems")
                        .HasForeignKey("AddInventoryModelId")
